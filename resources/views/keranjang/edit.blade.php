...
@section('konten')
    ...
    <form action="{{ route('keranjang.update', $keranjang->NRP) }}" method="POST" onsubmit="return validasiForm()">
        @csrf
        @method('PUT')

        <p>
            <label>NRP</label><br>
            <input type="text" name="NRP" id="NRP" maxlength="10" value="{{ old('NRP', $keranjang->NRP) }}">
        </p>

        <p>
            <label>Nama</label><br>
            <input type="text" name="Nama" id="Nama" maxlength="20" value="{{ old('Nama', $keranjang->Nama) }}">
        </p>

        <p>
            <label>Kelas</label><br>
            <input type="text" name="Kelas" id="Kelas" maxlength="5" value="{{ old('Kelas', $keranjang->Kelas) }}">
        </p>

        <p>
            <label>Tanggal Lahir</label><br>
            <input type="date" name="TanggalLahir" id="TanggalLahir"
                value="{{ old('TanggalLahir', $keranjang->TanggalLahir) }}">
        </p>
